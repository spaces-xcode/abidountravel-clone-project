  ...
  <section id="home" className="relative overflow-hidden">
    ...
    <div className="relative container py-24 md:py-36 text-center text-primary-foreground">
      ...
      <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
        Hajj &amp; Umrah <span className="text-gold-gradient">All-Inclusive</span> Packages
      </h1>
      <p className="max-w-2xl mx-auto text-base md:text-lg text-primary-foreground/80 mb-10">
        Your trusted guide for a sacred journey. Book with confidence — flights, visas,
        hotels and transport, all arranged by our specialists.
      </p>
